...
import ModelSelections from "./ModelSelections";
...
function ChatInput({ chatId }: Props) {
    ...
    const { data: model, mutate: setMo} = useSWR("models", {
    ...
    const sendMessage = async (e: FormEvent<HTMLFormElement>) => {
      ...
      const notification = toast.loading('Talkie wants to talk...');
      ...
      await fetch('/api/askQuestion', {
        ...
        toast.success('Talkie just talked!', {
            id: notification,
        })
      })
    };
